...
class BsfTest(StartEnd, BaseView):
    ...
    first_oa = (By.XPATH, '//*[@id="datagrid-row-r1-2-0"]/td[6]/div')  # 第一条数据的OA号
    search_xmmc = (By.XPATH, '//*[@id="searchBox"]/div/div/span/input')  # 搜索框-项目名称
    search_skr = (By.XPATH, '//*[@id="searchBox"]/div/div[2]/span/input')  # 搜索框-收款人
    search_oa = (By.XPATH, '//*[@id="searchBox"]/div/div[3]/span/input')  # 搜索框-OA号
    searchBtn = (By.XPATH, '//*[@id="searchBox"]/div[1]/div[4]/a[1]')  # 查询
    modifyBtn = (By.XPATH, '//*[@id="datagrid-row-r1-2-0"]/td[9]/div/a[1]')  # 修改
    srk_je = (By.XPATH, '//*[@id="_easyui_textbox_input6"]')  # 金额输入框
    num_je_text = '2333'  # 金额输入
    submitBtn = (By.XPATH, '//*[@id="myFormId"]/table[2]/tbody/tr/td/a[1]')  # 提交
    ...
    def test_login_zhaobingcheng(self):
        ...
        try:
            ...
            logging.info('===标书费金额修改成功===')
        except:
            logging.info('===标书费金额修改失败===')
            l.getScreenShot('标书费金额修改失败')
