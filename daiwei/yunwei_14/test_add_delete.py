...
class GldTest(StartEnd, BaseView):
    ...
    gl_class = (By.XPATH, '//*[@id="subjectorgForm"]/table/tbody/tr[1]/td[2]/span[1]')  # 杆路级别
    gl_class_select = (By.XPATH, '/html/body/div[12]/div/div')  # 一干
    property_nature = (By.XPATH, '//*[@id="subjectorgForm"]/table/tbody/tr[1]/td[4]/span[1]')  # 产权性质
    property_nature_select = (By.XPATH, '/html/body/div[13]/div/div')  # 自建
    province = (By.XPATH, '//*[@id="subjectorgForm"]/table/tbody/tr[3]/td[2]/span[1]')  # 所属省份
    province_select = (By.XPATH, '/html/body/div[9]/div/div')  # 北京市
    city = (By.XPATH, '//*[@id="subjectorgForm"]/table/tbody/tr[3]/td[4]/span[1]')  # 所属市
    city_select = (By.XPATH, '/html/body/div[19]/div/div')  # 北京市
    county = (By.XPATH, '//*[@id="subjectorgForm"]/table/tbody/tr[5]/td[2]/span')  # 区/县
    county_select = (By.XPATH, '/html/body/div[18]/div/div')  # 东城区
    ...
    start_type_select = (By.XPATH, '/html/body/div[10]/div/div[3]')  # 人手井
    end_type = (By.XPATH, '//*[@id="subjectorgForm"]/table/tbody/tr[7]/td[4]/span[1]')  # 终点设施类型
    end_type_select = (By.XPATH, '/html/body/div[11]/div/div[3]')  # 人手井
    ...
    end_name_select = (By.XPATH, '/html/body/div[21]/div//*[text()="333测试"]')  # 333测试
    share_unit = (By.XPATH, '//*[@id="subjectorgForm"]/table/tbody/tr[11]/td[2]/span[1]')  # 共享单位
    share_unit_select = (By.XPATH, '/html/body/div[15]/div/div[2]')  # 电信
    co_unit = (By.XPATH, '//*[@id="subjectorgForm"]/table/tbody/tr[11]/td[4]/span[1]')  # 共建单位
    co_unit_select = (By.XPATH, '/html/body/div[16]/div/div[2]')  # 电信
    property_unit = (By.XPATH, '//*[@id="subjectorgForm"]/table/tbody/tr[16]/td[4]/span[1]')  # 产权单位
    property_unit_select = (By.XPATH, '/html/body/div[17]/div/div[3]')  # 电信
    submitBtn = (By.XPATH, '//*[@id="dd"]/div[1]/div/a[1]/span/span')  # 提交
    close_alert = (By.XPATH, '//*[@id="dd"]/div[1]/div/a[2]/span/span')  # 关闭新增弹框
    resetBtn = (By.XPATH, '//*[@id="searchBox"]/ul[2]/li[3]/a[2]')  # 重置

    pageNum = (By.XPATH, '//*[@id="tt"]/div[1]/div/div[2]/div[1]')  # 右下角数据统计
    dele_firstBtn = (By.XPATH, '//*[@id="datagrid-row-r1-2-0"]/td[18]/div/a[2]')  # 第一条数据的删除按钮
    dele_certainBtn = (By.XPATH, '//*[text()="确定"]')  # 删除的确定

    select_one = (By.XPATH, '//*[@id="datagrid-row-r1-2-0"]/td[1]/div/input')  # 勾选第1条数据
    ...
    # 新增
        ...
        time.sleep(1)
        self.driver.find_element(*self.gl_class).click()
        self.driver.find_element(*self.gl_class_select).click()
        ...
        try:
            ...
            logging.info('杆路段信息管理新增成功')
        except:
            logging.info('杆路段信息管理新增失败')
            l.getScreenShot('杆路段信息管理新增失败')
        time.sleep(1)
    ...
    # 删除
        ...
        try:
            ...
            logging.info('杆路段信息管理删除成功')
        except:
            logging.info('杆路段信息管理删除失败')
            l.getScreenShot('杆路段信息管理删除失败')
        time.sleep(1)
    ...
    # 批量删除
        self.driver.find_element(*self.select_one).click()
        ...
        time.sleep(1)
        try:
            assert af_batchdele_NUM == af_add_NUM - 1
            logging.info('杆路段信息管理批量删除成功')
        except:
            logging.info('杆路段信息管理批量删除失败')
            l.getScreenShot('杆路段信息管理批量删除失败')
